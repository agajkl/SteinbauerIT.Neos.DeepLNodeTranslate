...
var TranslateDialog = (_dec = (0, _reactRedux.connect)((0, _plowJs.$transform)({
...
}), _dec(_class = _dec2(_class = class TranslateDialog extends _react.Component {
	...
	render() {
		...
		var isInArray = function isInArray() {
			for (var i in nodeTypeConfiguration) {
				if (i === node.nodeType) {
					return true;
				}
			}
...
exports.default = TranslateDialog;
var TranslateDialogSelect = class TranslateDialogSelect extends _react.Component {
	...
	render() {
		...
		var toArray = function toArray(objectValues) {
			var result = [];
			var count = 0;
		...
		return _react2.default.createElement(
			...
			Object.keys(dimensions).map(function (dimension, i) {
				return _react2.default.createElement(
					_react.Fragment,
					null,
					_react2.default.createElement(
						...
						Object.values(dimensions)[i].label
					),
					_react2.default.createElement(_reactUiComponents.SelectBox, { name: 'source[' + i + '][]', placeholder: 'Choose ' + Object.values(dimensions)[i].label, options: toArray(Object.values(dimensions)[i].presets), value: value, onValueChange: function onValueChange(p) {
							return setValue(p);
						} })
				);
			})
...
var _TranslateDialog = __webpack_require__(/*! ./TranslateDialog */ "./src/TranslateDialog.js");

var _TranslateDialog2 = _interopRequireDefault(_TranslateDialog);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('SteinbauerIT.Neos.DeepLNodeTranslate:NodeTranslator', {}, function (globalRegistry, _ref) {
	...
	var nodeTypeConfiguration = frontendConfiguration['SteinbauerIT.Neos.DeepLNodeTranslate:NodeTypes'];
	var dimensions = frontendConfiguration['SteinbauerIT.Neos.DeepLNodeTranslate:Dimensions'];
...
var DeepLTranslate = function DeepLTranslate(nodeTypeConfiguration, dimensions) {
	return class deepLTranslate extends _react.PureComponent {
		...
		render() {
			...
			return _react2.default.createElement(
				_react.Fragment,
				null,
				_react2.default.createElement(_TranslateDialog2.default, { nodeTypeConfiguration: nodeTypeConfiguration, dimensions: dimensions })
			);
		}
	};
};
